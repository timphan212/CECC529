...
public class DiskInvertedIndex {
    ...
    /**
     * Retrieves the number of terms in the biword index
     * @return an integer representing the count
     */
    ...
    /**
     * Get the terms in the biword index
     * @return an arraylist of string representing the terms in the biword index
     */
